...
def create_df_from_notion_db(raw_notion_db) -> pd.DataFrame:
    ...
    for row in raw_notion_db:
        data_row = {
            ...
            if (
                "prompt_zero_ref" in row["properties"]
                and row["properties"]["prompt_zero_ref"]["rich_text"]
            )
            else None,
            ...
            if (
                "prompt_single_ref" in row["properties"]
                and row["properties"]["prompt_single_ref"]["rich_text"]
            )
            else None,
            ...
            if (
                "prompt_multi_ref" in row["properties"]
                and row["properties"]["prompt_multi_ref"]["rich_text"]
            )
            else None,
