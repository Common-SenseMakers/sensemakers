...
export const PROV_HAS_PUBLICATION_INFO = 'http://www.w3.org/ns/prov#hasPublicationInfo';
...
export const NP_DECLARED_AS_DELEGATION_BY = 'http://purl.org/nanopub/x/declaredAsDelegationBy';
...
export const NP_HAS_SIGNATURE_TARGET = 'http://purl.org/nanopub/x/hasSignatureTarget';
export const NP_HAS_ROOT_SIGNER = 'https://sense-nets.xyz/hasRootSigner';
export const NP_HAS_DERIVATION_PATH = 'https://sense-nets.xyz/hasDerivationPath';
export const NP_HAS_DERIVATION_STANDARD = 'https://sense-nets.xyz/hasDerivationStandard';
export const NP_HAS_DERIVATION_PROOF = 'https://sense-nets.xyz/hasDerivationProof';
export const NP_HAS_SIGNATURE_TARGET_TEXT = 'https://sense-nets.xyz/hasSignatureTargetText';
...
export const RDF_SYNTAX_NS_TYPE = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type';
