...
const POSTS_JOB_SCHEDULE = defineString('POSTS_JOB_SCHEDULE');
...
const NP_PUBLISH_PRIVATE_KEY = defineSecret('NP_PUBLISH_PRIVATE_KEY');
...
export const envRuntime = {
  ...
  POSTS_JOB_SCHEDULE: POSTS_JOB_SCHEDULE,
  ...
  NP_PUBLISH_PRIVATE_KEY: NP_PUBLISH_PRIVATE_KEY,
};
